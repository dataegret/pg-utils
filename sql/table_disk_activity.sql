...
(
        SELECT
                greatest(1, sum(pg_stat_get_blocks_fetched(c.oid)-pg_stat_get_blocks_hit(c.oid)+pg_stat_get_blocks_fetched(c.reltoastrelid)-pg_stat_get_blocks_hit(c.reltoastrelid)+pg_stat_get_blocks_fetched(c.reltoastidxid)-pg_stat_get_blocks_hit(c.reltoastidxid))) as disk,
...
SELECT
        ...
        (pg_stat_get_blocks_fetched(c.oid)-pg_stat_get_blocks_hit(c.oid)+pg_stat_get_blocks_fetched(c.reltoastrelid)-pg_stat_get_blocks_hit(c.reltoastrelid)+pg_stat_get_blocks_fetched(c.reltoastidxid)-pg_stat_get_blocks_hit(c.reltoastidxid))/GREATEST(1, (pg_stat_get_tuples_inserted(c.oid)+pg_stat_get_tuples_inserted(c.reltoastrelid)+2*(pg_stat_get_tuples_updated(c.oid)+pg_stat_get_tuples_updated(c.reltoastrelid))+pg_stat_get_tuples_deleted(c.oid)+pg_stat_get_tuples_deleted(c.reltoastrelid))) AS ratio,
        pg_stat_get_blocks_fetched(c.oid)-pg_stat_get_blocks_hit(c.oid)+pg_stat_get_blocks_fetched(c.reltoastrelid)-pg_stat_get_blocks_hit(c.reltoastrelid)+pg_stat_get_blocks_fetched(c.reltoastidxid)-pg_stat_get_blocks_hit(c.reltoastidxid) AS disk,
        ((100*(pg_stat_get_blocks_fetched(c.oid)-pg_stat_get_blocks_hit(c.oid)+pg_stat_get_blocks_fetched(c.reltoastrelid)-pg_stat_get_blocks_hit(c.reltoastrelid)+pg_stat_get_blocks_fetched(c.reltoastidxid)-pg_stat_get_blocks_hit(c.reltoastidxid)))/(SELECT disk FROM totals_counts))::numeric(5,2) AS "disk%",
        ((SELECT SUM(pg_stat_get_tuples_fetched(i.indexrelid))::bigint FROM pg_index i WHERE i.indrelid=c.oid) + pg_stat_get_tuples_fetched(c.oid))/GREATEST(1, (pg_stat_get_blocks_fetched(c.oid)-pg_stat_get_blocks_hit(c.oid)+pg_stat_get_blocks_fetched(c.reltoastrelid)-pg_stat_get_blocks_hit(c.reltoastrelid)+pg_stat_get_blocks_fetched(c.reltoastidxid)-pg_stat_get_blocks_hit(c.reltoastidxid))) AS rt_d_rat,
...
AND (
        ...
        OR
        pg_stat_get_tuples_inserted(c.oid)+pg_stat_get_tuples_inserted(c.reltoastrelid)+2*(pg_stat_get_tuples_updated(c.oid)+pg_stat_get_tuples_updated(c.reltoastrelid))+pg_stat_get_tuples_deleted(c.oid)+pg_stat_get_tuples_deleted(c.reltoastrelid)+pg_stat_get_blocks_fetched(c.reltoastidxid)-pg_stat_get_blocks_hit(c.reltoastidxid)>10
)
